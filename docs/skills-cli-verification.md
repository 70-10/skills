...
Verified on 2026-08-14 with `skills` CLI 1.5.22.
...
- Discovery returned exactly nine skills: `adr`, `align`, `brief`, `discover`, `elaborate`, `first-bet`, `investigate`, `refine`, and `tdd`.
- Discovery did not return `dev`, `flow`, `decompose`, `implement`, `verify`, or `review`.
- Claude Code project installation created all nine `SKILL.md` files under `.claude/skills/`.
- Codex project installation created all nine `SKILL.md` files under `.agents/skills/`.
